...
public class TransactionRepositoryImplTest extends DummyObject {
    ...
    public void findTransactionList_all_test() throws Exception {
        ...
        // then
        assertThat(transactionListPS.get(0).getWithdrawAccountBalance()).isEqualTo(900L);
        // assertThat(transactionListPS.get(0).getDepositAccountBalance()).isEqualTo(900L);
        // // (강의)
    }
    ...
    private void dataSetting() {
        // (이체 Transaction은 현재 구현x ... 때문에 이체 테스트에 필요한 더미데이터, 테스트코드는 주석으로 남김)
